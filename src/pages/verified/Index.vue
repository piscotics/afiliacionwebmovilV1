...
export default {
  ...
  mounted() {
      ...
      console.log("elemento noooo existe")
      var recaptchaScript = document.createElement('script')
      recaptchaScript.setAttribute('src', 'https://www.piscotics.com/PiscoWeb/scriptCanvasPruebaPiscoTics.js')
      recaptchaScript.setAttribute("id", "scriptCanvas");
 ...
 // beforeDestroy() {
   ...
   // document.head.removeChild(document.getElementById("scriptCanvas"))
