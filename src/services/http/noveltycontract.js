...
export const Noveltycontract =  {
    list: async() => {
        ...
        return await api
            .get(endpoint.apiNoveltycontract + "list/", { params, headers })
            .then((response) => {
                return response
            })
            .catch ((err) => {
    ...
    create: async(value) => {
        ...
        return await api
            .post(endpoint.apiNoveltycontract + "create/", data, { headers })
            .then((response) => {
                return response
            })
            .catch ((err) => {
    ...
    edit: async(idNovedadContrato, newData) => {
      ...
      return await api
        .put(endpoint.apiNoveltycontract + "update/", data, { headers }).then((response) => {
          return response
        })
        .catch ((err) => {
            return err.response
    ...
    get: async(idNovedadContrato) => {
        ...
        return await api
            .get(endpoint.apiNoveltycontract + "get/", {params, headers})
            .then((response) => {
                return response
            })
            .catch ((err) => {
